...
%%%%%%%%%%%%%%%%%%%%%%%%% Cross-validation
[optmix,optdelta]=GMKLIEP_LCV(x_de,x_nu);

%%%%%%%%%%%%%%%%%%%%%%%%% Initialization by k-means
x = [x_de';x_nu'];
[Priors0,Mu0,Sigma0] = Init_EM(x,optmix); %kmeans;

%%%%%%%%%%%%%%%%%%%%%%%%% GMKLIEP
[Priors, Mu, Sigma,loglikall] = GMKLIEP(x_nu, x_de, Priors0, Mu0, Sigma0, optdelta);

wh_xdisp = normpdf_mat(xdisp,Priors,Mu,Sigma);
wh_x_de = normpdf_mat(x_de,Priors,Mu,Sigma);
%%%%%%%%%%%%%%%%%%%%%%%%% Displaying results
figure(1)
clf
hold on
...
set(gcf,'PaperUnits','centimeters');
set(gcf,'PaperPosition',[0 0 12 9]);
print('-dpng',sprintf('importance%g',dataset))
